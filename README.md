...
* [Dorado](https://github.com/nanoporetech/dorado) ⭐ 860 | 🐛 94 | 🌐 C++ | 📅 2026-07-30 - \[C++] - Production basecaller from 2022, successor to Guppy.
...
* [f5c eventalign](https://github.com/hasindu2008/f5c) ⭐ 166 | 🐛 3 | 🌐 C | 📅 2026-08-21 - \[C/C++/CUDA] - [GPU accelerated adaptive banded event alignment for rapid comparative nanopore signal analysis](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-020-03697-x)
* [f5c resquiggle](https://github.com/hasindu2008/f5c) ⭐ 166 | 🐛 3 | 🌐 C | 📅 2026-08-21 - \[C/C++/CUDA] - [GPU accelerated adaptive banded event alignment for rapid comparative nanopore signal analysis](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-020-03697-x)
...
* [modkit](https://github.com/nanoporetech/modkit) ⭐ 272 | 🐛 320 | 🌐 Rust | 📅 2026-07-14 - \[Rust] - Extract modified base calls from dorado BAM output to bedMethyl format, also calculate DMRs
* [f5c call-methylation](https://github.com/hasindu2008/f5c) ⭐ 166 | 🐛 3 | 🌐 C | 📅 2026-08-21 - \[C/C++/CUDA] - [GPU accelerated adaptive banded event alignment for rapid comparative nanopore signal analysis](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-020-03697-x)
* [DeepSignals](https://github.com/bioinfomaticsCSU/deepsignal) ⭐ 120 | 🐛 13 | 🌐 Python | 📅 2023-06-04 - \[Python] - [DeepSignal: detecting DNA methylation state from Nanopore sequencing reads using deep-learning](https://academic.oup.com/bioinformatics/article/35/22/4586/5474907).
...
* [Dorado](https://github.com/nanoporetech/dorado) ⭐ 860 | 🐛 94 | 🌐 C++ | 📅 2026-07-30 - \[C++] - [Supports calling 8 different RNA modifications: inosine, m6A, 2′OmeA on A; pseU, 2′OmeU on U; m5C, 2′OmeC on C; and 2′OmeG on G as of May 2025](https://software-docs.nanoporetech.com/dorado/1.4.0/models/list/)
