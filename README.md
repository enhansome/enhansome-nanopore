...
List of software packages for Nanopore sequencing data analysis, including basecalling, DNA/RNA modifications, etc. [Contributions welcome](https://github.com/goekelab/awesome-nanopore#contributing) ⭐ 325 | 🐛 1 | 📅 2026-05-20...
...
* [Dorado](https://github.com/nanoporetech/dorado) ⭐ 862 | 🐛 93 | 🌐 C++ | 📅 2026-07-30 - \[C++] - Production basecaller from 2022, successor to Guppy.
...
* [NanoPlot](https://github.com/wdecoster/nanoplot) ⭐ 559 | 🐛 17 | 🌐 HTML | 📅 2026-08-18 - \[HTML/Python] - [QC plotting tool for Nanopore reads](https://academic.oup.com/bioinformatics/article/39/5/btad311/7160911?login=false)
...
* [minimap2](https://github.com/lh3/minimap2) ⭐ 2,239 | 🐛 74 | 🌐 C | 📅 2026-05-19 - \[C] - [Minimap2: pairwise alignment for nucleotide sequences](https://academic.oup.com/bioinformatics/article/34/18/3094/4994778)
...
* [slow5tools](https://github.com/hasindu2008/slow5tools) ⭐ 106 | 🐛 0 | 🌐 C | 📅 2026-08-19 - \[C/C++] - [Toolkit for converting (FAST5 <-> SLOW5), compressing, viewing, indexing and manipulating data in SLOW5 format](https://hasindu2008.github.io/slow5tools/)
...
* [modkit](https://github.com/nanoporetech/modkit) ⭐ 272 | 🐛 321 | 🌐 Rust | 📅 2026-07-14 - \[Rust] - Extract modified base calls from dorado BAM output to bedMethyl format, also calculate DMRs
...
* [Dorado](https://github.com/nanoporetech/dorado) ⭐ 862 | 🐛 93 | 🌐 C++ | 📅 2026-07-30 - \[C++] - [Supports calling 8 different RNA modifications: inosine, m6A, 2′OmeA on A; pseU, 2′OmeU on U; m5C, 2′OmeC on C; and 2′OmeG on G as of May 2025](https://software-docs.nanoporetech.com/dorado/1.4.0/models/list/)
...
* [xPore](https://github.com/GoekeLab/xpore) ⭐ 168 | 🐛 34 | 🌐 Python | 📅 2026-08-05 - \[Python] - [Identification of differential RNA modifications from nanopore direct RNA sequencing with xPore](https://doi.org/10.1038/s41587-021-00949-w).
* [m6anet](https://github.com/GoekeLab/m6anet) ⭐ 133 | 🐛 25 | 🌐 Python | 📅 2025-05-19 - \[Python] - [Detection of m6A from direct RNA sequencing using a multiple instance learning framework](https://www.nature.com/articles/s41592-022-01666-1).
...
* [FLAIR](https://github.com/BrooksLabUCSC/FLAIR) ⭐ 256 | 🐛 140 | 🌐 Python | 📅 2026-08-20 - \[Python] - [Full-Length Alternative Isoform analysis of RNA](https://www.nature.com/articles/s41467-020-15171-6)
...
* [IsoQuant](https://github.com/ablab/IsoQuant) ⭐ 235 | 🐛 17 | 🌐 Python | 📅 2026-08-20 - \[Python] - [Accurate isoform discovery with IsoQuant using long reads](https://www.nature.com/articles/s41587-022-01565-y)
...
* [bambu-pipe](https://github.com/GoekeLab/bambu-pipe) ⭐ 23 | 🐛 4 | 🌐 Nextflow | 📅 2026-08-21 - \[Nextflow] - [Isoform-level discovery, quantification and fusion analysis from single-cell and spatial long-read RNA-seq data with Bambu-Clump](https://www.biorxiv.org/content/10.1101/2024.12.30.630828v1.full)
