...
* [Dorado](https://github.com/nanoporetech/dorado) ⭐ 858 | 🐛 93 | 🌐 C++ | 📅 2026-07-30 - \[C++] - Production basecaller from 2022, successor to Guppy.
...
* [minimap2](https://github.com/lh3/minimap2) ⭐ 2,231 | 🐛 74 | 🌐 C | 📅 2026-05-19 - \[C] - [Minimap2: pairwise alignment for nucleotide sequences](https://academic.oup.com/bioinformatics/article/34/18/3094/4994778)
...
* [f5c eventalign](https://github.com/hasindu2008/f5c) ⭐ 166 | 🐛 6 | 🌐 C | 📅 2026-03-19 - \[C/C++/CUDA] - [GPU accelerated adaptive banded event alignment for rapid comparative nanopore signal analysis](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-020-03697-x)
...
* [modkit](https://github.com/nanoporetech/modkit) ⭐ 272 | 🐛 318 | 🌐 Rust | 📅 2026-07-14 - \[Rust] - Extract modified base calls from dorado BAM output to bedMethyl format, also calculate DMRs
* [f5c call-methylation](https://github.com/hasindu2008/f5c) ⭐ 166 | 🐛 6 | 🌐 C | 📅 2026-03-19 - \[C/C++/CUDA] - [GPU accelerated adaptive banded event alignment for rapid comparative nanopore signal analysis](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-020-03697-x)
...
* [Dorado](https://github.com/nanoporetech/dorado) ⭐ 858 | 🐛 93 | 🌐 C++ | 📅 2026-07-30 - \[C++] - [Supports calling 8 different RNA modifications: inosine, m6A, 2′OmeA on A; pseU, 2′OmeU on U; m5C, 2′OmeC on C; and 2′OmeG on G as of May 2025](https://software-docs.nanoporetech.com/dorado/1.4.0/models/list/)
...
* [xPore](https://github.com/GoekeLab/xpore) ⭐ 168 | 🐛 33 | 🌐 Python | 📅 2026-08-05 - \[Python] - [Identification of differential RNA modifications from nanopore direct RNA sequencing with xPore](https://doi.org/10.1038/s41587-021-00949-w).
* [m6anet](https://github.com/GoekeLab/m6anet) ⭐ 133 | 🐛 25 | 🌐 Python | 📅 2025-05-19 - \[Python] - [Detection of m6A from direct RNA sequencing using a multiple instance learning framework](https://www.nature.com/articles/s41592-022-01666-1).
* [EpiNano](https://github.com/novoalab/EpiNano) ⭐ 118 | 🐛 8 | 🌐 Python | 📅 2026-03-02 - \[Python] - [Accurate detection of m6A RNA modifications in native RNA sequences](https://www.nature.com/articles/s41467-019-11713-9).
...
* [Autocycler](https://github.com/rrwick/Autocycler) ⭐ 236 | 🐛 0 | 🌐 Rust | 📅 2026-08-12 - \[Rust] - [Autocycler: long-read consensus assembly for bacterial genomes](https://academic.oup.com/bioinformatics/article/41/9/btaf474/8242761)
...
* [FLAIR](https://github.com/BrooksLabUCSC/FLAIR) ⭐ 255 | 🐛 146 | 🌐 Python | 📅 2026-08-11 - \[Python] - [Full-Length Alternative Isoform analysis of RNA](https://www.nature.com/articles/s41467-020-15171-6)
* [bambu](https://github.com/GoekeLab/bambu) ⭐ 253 | 🐛 54 | 🌐 R | 📅 2026-08-11 - \[R] - [Context-Aware Transcript Quantification from Long Read RNA-Seq data with Bambu](https://rdcu.be/deluQ)
* [IsoQuant](https://github.com/ablab/IsoQuant) ⭐ 234 | 🐛 16 | 🌐 Python | 📅 2026-08-07 - \[Python] - [Accurate isoform discovery with IsoQuant using long reads](https://www.nature.com/articles/s41587-022-01565-y)
...
* [RNAbloom2](https://github.com/bcgsc/RNA-Bloom) ⭐ 110 | 🐛 12 | 🌐 Java | 📅 2026-03-13 - \[Java] - [Reference-free assembly of long-read transcriptome sequencing data with RNA-Bloom2](https://www.nature.com/articles/s41467-023-38553-y)
